...
class Board(Frame):
    ...
    def __init__(self, parent, length, width, background_color="brown", border_thickness=5, border_color="black"): 
        ...
        self.border_thickness = border_thickness
        self.border_color = border_color
        self.config(height=100*self.length, width=100*self.width, bg=self.background_color, highlightthickness=self.border_thickness, highlightbackground=self.border_color)
        self.pack()
        self.square_color = None
        self.squares = {}
        self.ranks = string.ascii_lowercase
